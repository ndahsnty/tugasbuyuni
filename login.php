...
<body>
      ...
      <style type="text/css">
          ...
          <form action="" class="log-in" autocomplete="off"> 
              <h4>LOGIN</h4>
            <h4><img src="assets/img/logo-text.jpg" alt="" width="250"></h4>
...
<script>
    function Login(){
        $text_username = $("#username").val();
        $password = $("#password").val();
        if($text_username != ""){
            if($password != ""){
                if($text_username.length > 8){
                    swal({
                        title: "Selamat Datang!",
                        text: "Di Dapur Kuliner!",
                        icon: "success",
                        button: "Ok!",
                    }).then((value) => {
